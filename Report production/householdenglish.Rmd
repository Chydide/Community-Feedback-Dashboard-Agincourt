...
<div class = "col-md-4">
## Population
 ![*In `r params$year`, there were `r Pop$MidYearPop` people living in `r Households$HouseholdCnt` households, with `r Pop$MalePop` men and `r Pop$FemalePop` women.*](C:\Users\Chido\Documents\CFB Reports\HF_Population.png)
</div>
  
<div class = "col-md-4">
## Education
 ![*In `r params$year`, there were `r edu$M + edu$F` learners (aged 5-19), with  `r edu$M` males and `r edu$F` females.*](C:\Users\Chido\Documents\CFB Reports\HF_Education.png)
</div>
  
<div class = "col-md-4">
## The elderly
![*In `r params$year` there were `r popage$Total` people over the age of 60.  Of this there were `r popage$Male` men and `r popage$Female` women.*](C:\Users\Chido\Documents\CFB Reports\HF_Elderly.png)
</div>
</div>
...
<div class = "col-md-4">
## Births
 ![*In `r params$year`, there were a total of `r freq$TotalBirth` babies born, and `r freq$MaleBirth` were boys,  and `r freq$FemaleBirth` were girls.*](C:\Users\Chido\Documents\CFB Reports\HF_Birth.png)
</div>
  
<div class = "col-md-4">
## Deaths
 ![*In `r params$year`, a total of `r freq$TotalDeaths` people died, `r freq$MaleDeaths` were male and `r freq$FemaleDeaths` women.*](C:\Users\Chido\Documents\CFB Reports\HF_Death.png)
</div>
  
<div class = "col-md-4">
## Migration
![*In `r params$year`, `r freq$'TotInMig&lntMig'` people moved into the village and `r freq$TotMigExtMig` moved out.*](C:\Users\Chido\Documents\CFB Reports\HF_Migration.png)
</div>
</div>
