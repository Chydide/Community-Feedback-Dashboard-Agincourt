...
colnames(watersupply) <- c("Year","Wamati","NhlayoyaMiMiti")
#watersupply$Source <- as.character(watersupply$Source)
watersupply[watersupply == "Tap in House"]<-"Pompi yale ndlwini"
watersupply[watersupply == "Tap in Yard"]<-"Pompi yale jaratini"
watersupply[watersupply == "Tap in Street"]<-"Pompi yale xitaratini"
watersupply[watersupply == "Truck"]<-"Lori ya Mati"
watersupply[watersupply == "Pond"]<-"Xidan'wana"
watersupply[watersupply == "River"]<-"Nambu"
watersupply[watersupply == "Dam"]<-"Nhlongolwani"
watersupply[watersupply == "Rainwater tank"]<-"Tangi ra mati"
watersupply[watersupply == "Other"]<-"Swin'wani"
watersupply[watersupply == "Cement well"]<-"Xidan'wana"

watersupply %>%
  select( Wamati, NhlayoyaMiMiti) %>%
  arrange(desc(NhlayoyaMiMiti)) %>%
  head(.,5) -> n1
  ggplot(n1,  aes(x=reorder(Wamati,-NhlayoyaMiMiti), y=NhlayoyaMiMiti))+
...
#library(stargazer)
knitr::kable(n1, caption = "Tafura ra mphakelo wa mati")
